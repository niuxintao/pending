...
Proposition \ref{pro:determinablehealthy} shows that only the schemas contained in those existed passing test cases can be determined to be healthy schemas.  As an example, consider $T_{pass}$ contains one test case, which are \{($p_{1}, 0$), ($p_{2}, 0$), ($p_{3}, 1$), ($p_{4}, 0$)\}. $T_{fail}$ contains two test cases, which are \{($p_{1}, 0$), ($p_{2}, 0$), ($p_{3}, 0$), ($p_{4}, 0$)\}, and \{($p_{1}, 0$), ($p_{2}, 0$), ($p_{3}, 0$), ($p_{4}, 1$)\}, respectively. Other test cases are in $T_{unknown}$. Table \ref{ex:determinableschemas} shows the schemas that can be determined to be healthy schemas.

\begin{table}[htbp]
  \centering
  \caption{An example of determinable schemas}
  \label{ex:determinableschemas}
    \begin{tabular}{|c|c|} \hline
     \multicolumn{2}{|c|}{\textbf{Failing test Case set $T_{fail}$}} \\ \hline
  $t_{1}$ & \{($p_{1}, 0$), ($p_{2}, 0$), ($p_{3}, 0$), ($p_{4}, 0$)\}\\
  $t_{2}$ & \{($p_{1}, 0$), ($p_{2}, 0$), ($p_{3}, 0$), ($p_{4}, 1$)\}\\ \hline
     \multicolumn{2}{|c|}{\textbf{Passing Test Case Set $T_{pass}$}} \\ \hline
  $t_{3}$ & \{($p_{1}, 0$), ($p_{2}, 0$), ($p_{3}, 1$), ($p_{4}, 0$)\} \\ \hline
        \multicolumn{2}{|c|}{\textbf{Unknown Test Case Set $T_{unknown}$}} \\ \hline
  $t_{4}$ & \{($p_{1}, 0$), ($p_{2}, 0$), ($p_{3}, 1$), ($p_{4}, 1$)\} \\
  $t_{5}$ & \{($p_{1}, 0$), ($p_{2}, 1$), ($p_{3}, 0$), ($p_{4}, 0$)\} \\
  $t_{6}$ & \{($p_{1}, 0$), ($p_{2}, 1$), ($p_{3}, 0$), ($p_{4}, 1$)\} \\
  $t_{7}$ & \{($p_{1}, 0$), ($p_{2}, 1$), ($p_{3}, 1$), ($p_{4}, 0$)\} \\
  $t_{8}$ & \{($p_{1}, 0$), ($p_{2}, 1$), ($p_{3}, 1$), ($p_{4}, 1$)\} \\

  $t_{9}$ & \{($p_{1}, 1$), ($p_{2}, 0$), ($p_{3}, 0$), ($p_{4}, 0$)\}\\
  $t_{10}$ & \{($p_{1}, 1$), ($p_{2}, 0$), ($p_{3}, 0$), ($p_{4}, 1$)\}\\
  $t_{11}$ & \{($p_{1}, 1$), ($p_{2}, 0$), ($p_{3}, 1$), ($p_{4}, 0$)\} \\
  $t_{12}$ & \{($p_{1}, 1$), ($p_{2}, 0$), ($p_{3}, 1$), ($p_{4}, 1$)\} \\
  $t_{13}$ & \{($p_{1}, 1$), ($p_{2}, 1$), ($p_{3}, 0$), ($p_{4}, 0$)\} \\
  $t_{14}$ & \{($p_{1}, 1$), ($p_{2}, 1$), ($p_{3}, 0$), ($p_{4}, 1$)\} \\
  $t_{15}$ & \{($p_{1}, 1$), ($p_{2}, 1$), ($p_{3}, 1$), ($p_{4}, 0$)\} \\
  $t_{16}$ & \{($p_{1}, 1$), ($p_{2}, 1$), ($p_{3}, 1$), ($p_{4}, 1$)\} \\ \hline
    \end{tabular}%
\quad
    \begin{tabular}{|c|c|} \hline
   ...
   $s_{9}$ & \{($p_{2}, 0$),($p_{4}, 0$)\} \\
   $s_{10}$ & \{($p_{3}, 1$),($p_{4}, 0$)\} \\
   $s_{11}$ & \{($p_{1}, 0$),($p_{2}, 0$),($p_{3}, 1$)\} \\
   $s_{12}$ & \{($p_{1}, 0$),($p_{2}, 0$),($p_{4}, 0$)\} \\
   $s_{13}$ & \{($p_{1}, 0$),($p_{3}, 1$),($p_{4}, 0$)\} \\
   $s_{14}$ & \{($p_{2}, 0$),($p_{3}, 1$),($p_{4}, 0$)\} \\
   $s_{15}$ & \{($p_{1}, 0$), ($p_{2}, 0$), ($p_{3}, 1$), ($p_{4}, 0$)\} \\ \hline

  \multicolumn{2}{|c|}{\textbf{Determined to be faulty $\mathcal{S}(T_{fail})$ }}  \\ \hline
  $s_{16}$ & \{($p_{1}, 0$), ($p_{2}, 0$), ($p_{3}, 0$)\}  \\
  $s_{17}$ & \{($p_{1}, 0$), ($p_{2}, 0$), ($p_{3}, 0$), ($p_{4}, 0$)\} \\
  $s_{18}$ & \{($p_{1}, 0$), ($p_{2}, 0$), ($p_{3}, 0$), ($p_{4}, 1$)\} \\ \hline
    \end{tabular}%
\end{table}
...
Proposition \ref{pro:determinablefaulty} shows that only special schemas of existed failing test cases can be determined to be faulty schemas.  For the same example discussed previously, Table \ref{ex:determinableschemas} also lists all the schemas that are determined to be faulty schemas.
...
As an example, we consider the same  $T_{fail}$, $T_{pass}$, and $T_{unknown}$ as in Table \ref{ex:determinableschemas}. The pending schemas for this example are listed in Table \ref{ex:pendingschemas}. We can learn that each schema in Table \ref{ex:pendingschemas} is neither contained in set $\mathcal{I}(T_{pass})$ nor contained in set $\mathcal{S}(T_{fail})$ of Table \ref{ex:determinableschemas}. Another observation from this Table is that all the pending schemas plus the determinable schemas are equal to whole set of  schemas that contained in the SUT, of which the number is $3^{4} - 1 = 80$.
...
\begin{table}[htbp]
  ...
  \label{ex:pendingschemas}
    \begin{tabular}{|c|c|} \hline
     \multicolumn{2}{|c|}{\textbf{1-way schemas}} \\ \hline
  $s_{19}$ & \{($p_{1}, 1$)\}\\
  $s_{20}$ & \{($p_{2}, 1$)\}\\
  $s_{21}$ & \{($p_{3}, 0$)\} \\
  $s_{22}$ & \{($p_{4}, 1$)\} \\ \hline
...
%\quad
%    \begin{tabular}{|c|c|} \hline
     \multicolumn{2}{|c|}{\textbf{2-way schemas}} \\ \hline
  ...
  $s_{40}$ & \{($p_{3}, 1$), ($p_{4}, 1$)\}\\ \hline
    \end{tabular}%
\quad
    \begin{tabular}{|c|c|} \hline
   \multicolumn{2}{|c|}{\textbf{3-way schemas}}\\ \hline
   $s_{41}$ & \{($p_{1}, 0$),($p_{2}, 0$), ($p_{4}, 1$)\} \\

   $s_{42}$ & \{($p_{1}, 0$),($p_{2}, 1$), ($p_{3}, 0$)\} \\
   $s_{43}$ & \{($p_{1}, 0$),($p_{2}, 1$), ($p_{3}, 1$)\} \\

   $s_{44}$ & \{($p_{1}, 0$),($p_{2}, 1$), ($p_{4}, 0$)\} \\
   $s_{45}$ & \{($p_{1}, 0$),($p_{2}, 1$), ($p_{4}, 1$)\} \\

   $s_{46}$ & \{($p_{1}, 0$),($p_{3}, 0$), ($p_{4}, 0$)\} \\
   $s_{47}$ & \{($p_{1}, 0$),($p_{3}, 0$), ($p_{4}, 1$)\} \\

   $s_{48}$ & \{($p_{1}, 0$),($p_{3}, 1$), ($p_{4}, 1$)\} \\


   $s_{49}$ & \{($p_{1}, 1$),($p_{2}, 0$), ($p_{3}, 0$)\} \\
   $s_{50}$ & \{($p_{1}, 1$),($p_{2}, 0$), ($p_{3}, 1$)\} \\
   $s_{51}$ & \{($p_{1}, 1$),($p_{2}, 0$), ($p_{4}, 0$)\} \\
   $s_{52}$ & \{($p_{1}, 1$),($p_{2}, 0$), ($p_{4}, 1$)\} \\
   $s_{53}$ & \{($p_{1}, 1$),($p_{2}, 1$), ($p_{3}, 0$)\} \\
   $s_{54}$ & \{($p_{1}, 1$),($p_{2}, 1$), ($p_{3}, 1$)\} \\
   $s_{55}$ & \{($p_{1}, 1$),($p_{2}, 1$), ($p_{4}, 0$)\} \\
   $s_{56}$ & \{($p_{1}, 1$),($p_{2}, 1$), ($p_{4}, 1$)\} \\

   $s_{57}$ & \{($p_{1}, 1$),($p_{3}, 0$), ($p_{4}, 0$)\} \\
   $s_{58}$ & \{($p_{1}, 1$),($p_{3}, 0$), ($p_{4}, 1$)\} \\
   $s_{59}$ & \{($p_{1}, 1$),($p_{3}, 1$), ($p_{4}, 0$)\} \\
   $s_{60}$ & \{($p_{1}, 1$),($p_{3}, 1$), ($p_{4}, 1$)\} \\

   $s_{61}$ & \{($p_{2}, 0$),($p_{3}, 0$), ($p_{4}, 0$)\} \\
   $s_{62}$ & \{($p_{2}, 0$),($p_{3}, 0$), ($p_{4}, 1$)\} \\

   $s_{63}$ & \{($p_{2}, 0$),($p_{3}, 1$), ($p_{4}, 1$)\} \\

   $s_{64}$ & \{($p_{2}, 1$),($p_{3}, 0$), ($p_{4}, 0$)\} \\
   $s_{65}$ & \{($p_{2}, 1$),($p_{3}, 0$), ($p_{4}, 1$)\} \\

   $s_{66}$ & \{($p_{2}, 1$),($p_{3}, 1$), ($p_{4}, 0$)\} \\
   $s_{67}$ & \{($p_{2}, 1$),($p_{3}, 1$), ($p_{4}, 1$)\} \\  \hline
    \end{tabular}%
    \quad
    \begin{tabular}{|c|c|} \hline
   \multicolumn{2}{|c|}{\textbf{4-way schemas}}\\ \hline
  $s_{68}$ & \{($p_{1}, 0$), ($p_{2}, 0$), ($p_{3}, 1$), ($p_{4}, 1$)\} \\
  $s_{69}$ & \{($p_{1}, 0$), ($p_{2}, 1$), ($p_{3}, 0$), ($p_{4}, 0$)\} \\
  $s_{70}$ & \{($p_{1}, 0$), ($p_{2}, 1$), ($p_{3}, 0$), ($p_{4}, 1$)\} \\
  $s_{71}$ & \{($p_{1}, 0$), ($p_{2}, 1$), ($p_{3}, 1$), ($p_{4}, 0$)\} \\
  $s_{72}$ & \{($p_{1}, 0$), ($p_{2}, 1$), ($p_{3}, 1$), ($p_{4}, 1$)\} \\

  $s_{73}$ & \{($p_{1}, 1$), ($p_{2}, 0$), ($p_{3}, 0$), ($p_{4}, 0$)\}\\
  $s_{74}$ & \{($p_{1}, 1$), ($p_{2}, 0$), ($p_{3}, 0$), ($p_{4}, 1$)\}\\
  $s_{75}$ & \{($p_{1}, 1$), ($p_{2}, 0$), ($p_{3}, 1$), ($p_{4}, 0$)\} \\
  $s_{76}$ & \{($p_{1}, 1$), ($p_{2}, 0$), ($p_{3}, 1$), ($p_{4}, 1$)\} \\
  $s_{77}$ & \{($p_{1}, 1$), ($p_{2}, 1$), ($p_{3}, 0$), ($p_{4}, 0$)\} \\
  $s_{78}$ & \{($p_{1}, 1$), ($p_{2}, 1$), ($p_{3}, 0$), ($p_{4}, 1$)\} \\
  $s_{79}$ & \{($p_{1}, 1$), ($p_{2}, 1$), ($p_{3}, 1$), ($p_{4}, 0$)\} \\
  $s_{80}$ & \{($p_{1}, 1$), ($p_{2}, 1$), ($p_{3}, 1$), ($p_{4}, 1$)\} \\ \hline
    \end{tabular}%
\end{table}
...
The proof of this equation is obvious and omitted here. In fact, Formula \ref{eq:pssfirst} is obtained by selecting those pending schemas (based on Formula \ref{eq:pss}) that are in test case $t$.  Since Formula \ref{eq:pssfirst} focus on these schemas that are in test case $t$, it reduces a lot of schemas that are needed to be considered when comparing with Formula \ref{eq:pss}. As an example, we use the same SUT used in Section \ref{sec:pending:pending}. That is, consider $T_{pass}$ to be \{ \{($p_{1}, 0$), ($p_{2}, 0$), ($p_{3}, 1$), ($p_{4}, 0$)\} \}, and $T_{fail}$ to be \{ \{($p_{1}, 0$), ($p_{2}, 0$), ($p_{3}, 0$), ($p_{4}, 0$)\},  \{($p_{1}, 0$), ($p_{2}, 0$), ($p_{3}, 0$), ($p_{4}, 1$)\} \}. Different from Section \ref{sec:pending:pending} which lists all the pending schemas, we only focus on the pending schemas in one failing test case, say, \{($p_{1}, 0$), ($p_{2}, 0$), ($p_{3}, 0$), ($p_{4}, 0$)\}. Table \ref{ex:pendingschemasinonetestcase} lists all the pending schemas in this test case. We can observe that there are only 6 schemas are selected from all the pending schemas listed in Table \ref{ex:pendingschemas}.
...
\begin{table}[htbp]
  ...
  \label{ex:pendingschemasinonetestcase}
   ...
   $t_{1}$ & \{($p_{1}, 0$), ($p_{2}, 0$), ($p_{3}, 0$), ($p_{4}, 0$)\}\\ \hline
   ...
   $s_{38}$ & \{($p_{3}, 0$),($p_{4}, 0$)\} \\
   $s_{46}$ & \{($p_{1}, 0$),($p_{3}, 0$),($p_{4}, 0$)\} \\
   $s_{61}$ & \{($p_{2}, 0$),($p_{3}, 0$),($p_{4}, 0$)\} \\ \hline
    \end{tabular}%
\end{table}
...
Let schema set $A$ = $\{ s\ |\ s \preceq t\ \&\&\ \forall p \in T_{pass}^{t}, s \npreceq p \}$, schema set $B$ = $\{ s\ |\ s \preceq t\ \&\&\ \forall p \in T_{pass}^{t\bigtriangleup}, s \npreceq p \}$. Then we have $A = B$.
\end{proposition}
...
Since $T_{pass}^{t\bigtriangleup} \subseteq T_{pass}^{t}$, we have $  \{ s | \forall p \in T_{pass}^{t}, s \npreceq p \} =  \{ s | \forall p \in T_{pass}^{t\bigtriangleup}, s \npreceq p \ \&\& \  \forall p \in T_{pass}^{t} \backslash T_{pass}^{t\bigtriangleup}, s \npreceq p \} \subseteq \{ s | \forall p \in T_{pass}^{t\bigtriangleup}, s \npreceq p \}$. Hence,  $\{ s\ |\ s \preceq t\ \&\&\ \forall p \in T_{pass}^{t}, s \npreceq p \} \subseteq  \{ s\ |\ s \preceq t\ \&\&\ \forall p \in T_{pass}^{t\bigtriangleup}, s \npreceq p \}$. That is,  $A \subseteq B$.

Next, we will prove $B \subseteq A$.

We assume that  $\exists s \in  \{ s | \forall p \in T_{pass}^{t\bigtriangleup}, s \npreceq p \}$, $ s \notin \{ s | \forall p \in T_{pass}^{t}, s \npreceq p \}$. It indicates that $\exists p' \in T_{pass}^{t}, s \preceq p'$. Since $p' \in T_{pass}^{t}$, $\exists p'' \in T_{pass}^{t\bigtriangleup}, p' \preceq p''$. It has $s \preceq p' \preceq p''$. This is contradiction.  Hence, the assumption does not hold, indicating that $\forall s \in  \{ s | \forall p \in T_{pass}^{t\bigtriangleup}$, $s \in  \{ s | \forall p \in T_{pass}^{t}, s \npreceq p \}$. Hence, $\{ s | \forall p \in T_{pass}^{t\bigtriangleup}$ $\subseteq$ $\{ s | \forall p \in T_{pass}^{t}, s \npreceq p \}$. Therefore, $\{ s\ |\ s \preceq t\ \&\&\ \forall p \in T_{pass}^{t\bigtriangleup}, s \npreceq p \}$ $\subseteq$ $\{ s\ |\ s \preceq t\ \&\&\ \forall p \in T_{pass}^{t}, s \npreceq p \} $. That is $B \subseteq A$.
...
PSS=\{ s\ |\ s \preceq t\ \&\&\ \forall m \in \mathcal{C}(T_{fail})^{t},  m \npreceq s  \ \&\&\  \forall p \in T_{pass}^{t\bigtriangleup}, s \npreceq p \} .
\end{aligned}
\end{equation}

\begin{proof}

Let A = $\{ s\ |\  s \preceq t\ \&\&\ \forall m \in \mathcal{C}(T_{fail}),  m \npreceq s \}$, B = $ \{ s\ |\ s \preceq t\ \&\&  \forall p \in T_{pass}, s \npreceq p \} $. Obviously, PSS = $A \cap B$.

According to Proposition \ref{pro:mfssintequal}, A = $\{ s\ |\  s \preceq t\ \&\&\ \forall m \in \mathcal{C}(T_{fail})^{t},  m \npreceq s \}$.
According to Proposition \ref{pro:healthysintequal} and Proposition \ref{pro:healthysintequal2}, B = $\{ s\ |\  s \preceq t\ \&\&\ \forall p \in T_{pass}^{t},  s \npreceq p \}$ = $\{ s\ |\  s \preceq t\ \&\&\ \forall p \in T_{pass}^{t\bigtriangleup},  s \npreceq p \}$.

Hence, $PSS$ = $A \cap B$ = $\{ s\ |\  s \preceq t\ \&\&\ \forall m \in \mathcal{C}(T_{fail})^{t},  m \npreceq s \}$ $\cap$ $\{ s\ |\  s \preceq t\ \&\&\ \forall p \in T_{pass}^{t\bigtriangleup},  s \npreceq p \}$ = $\{ s\ |\ s \preceq t\ \&\&\ \forall m \in \mathcal{C}(T_{fail})^{t},  m \npreceq s  \ \&\&\  \forall p \in T_{pass}^{t\bigtriangleup}, s \npreceq p \}$.
\end{proof}
