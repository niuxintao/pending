...
Combining the three observations, we can further remove some pending schemas in $t_{5}$ by elminiating the schemas that have already been appeared in the passing schemas. These schemas are 
