...
\section{Motivating example}\label{motiv}

Why minimal failure-causing schema is not effective? 
This exmaple shows that . Because there still existing pending schemas.
...
\subsection{Empirical studies}\label{emp}

\subsection{The existence of pending schemas}
