...
Formally,$\mathcal{T}(s) = \{ t | s \preceq t, |t| = n\}$. As an example, Table \ref{ex:wholecontainer} shows $\mathcal{T}($\{($p_{1}, 1$), ($p_{2}, 0$)\}$)$.  It can be observed that each possible test case contains  \{($p_{1}, 1$), ($p_{2}, 0$)\} is listed in Table \ref{ex:wholecontainer}.
...
\begin{table}[htbp]
  ...
  \label{ex:wholecontainer}
   ...
   \textbf{Schema} \\ \hline
    \{($p_{1}, 1$), ($p_{2}, 0$)\} \\ \hline
   \textbf{ $\mathcal{T}(s)$ }\\ \hline
    \{($p_{1}, 1$), ($p_{2}, 0$), ($p_{3}, 0$), ($p_{4}, 0$)\} \\
    \{($p_{1}, 1$), ($p_{2}, 0$), ($p_{3}, 0$), ($p_{4}, 1$)\} \\
    \{($p_{1}, 1$), ($p_{2}, 0$), ($p_{3}, 1$), ($p_{4}, 0$)\} \\
    \{($p_{1}, 1$), ($p_{2}, 0$), ($p_{3}, 1$), ($p_{4}, 1$)\} \\ \hline
    \end{tabular}
   % }
\end{table}%
...
Table \ref{ex:smallerschemahaslarger} shows the whose set of containers of  \{($p_{1}, 1$), ($p_{2}, 0$)\}  and its super-schema \{($p_{1}, 1$), ($p_{2}, 0$), ($p_{3}, 0$)\}. We can observe that $\mathcal{T}(\{(p_{1}, 1), (p_{2}, 0)\})$ subsumes  $\mathcal{T}(\{(p_{1}, 1), (p_{2}, 0), (p_{3}, 0)\})$.
...
\begin{table}[htbp]
 ...
 %   {\footnotesize
   ...
   \textbf{ $\mathcal{T}(s)$ }\\ \hline
    ...
    \{($p_{1}, 1$), ($p_{2}, 0$), ($p_{3}, 0$), ($p_{4}, 1$)\} \\
    \{($p_{1}, 1$), ($p_{2}, 0$), ($p_{3}, 1$), ($p_{4}, 0$)\} \\
    \{($p_{1}, 1$), ($p_{2}, 0$), ($p_{3}, 1$), ($p_{4}, 1$)\} \\ \hline\hline
    \textbf{ Schema} \\ \hline
    \{($p_{1}, 1$), ($p_{2}, 0$), ($p_{3}, 0$)\} \\ \hline
   \textbf{ $\mathcal{T}(s)$ }\\ \hline
    \{($p_{1}, 1$), ($p_{2}, 0$), ($p_{3}, 0$), ($p_{4}, 0$)\} \\
    \{($p_{1}, 1$), ($p_{2}, 0$), ($p_{3}, 0$), ($p_{4}, 1$)\} \\ \hline
    \end{tabular}%
   % }
\end{table}%
...
Formally,$\mathcal{I}(t) = \{ s | s \preceq t \}$. As an example, Table \ref{ex:wholesetofhitschemas} shows $\mathcal{I}$ ( \{($p_{1}, 1$), ($p_{2}, 0$), ($p_{3}, 0$), ($p_{4}, 0$)\}\ ). We can find it is a set of $2^{4} - 1 = 15$ schemas.
...
\begin{table}[htbp]
 ...
 %   {\footnotesize
   ...
   \textbf{Test Case} \\ \hline
    \{($p_{1}, 1$), ($p_{2}, 0$), ($p_{3}, 0$), ($p_{4}, 0$)\} \\ \hline
   \textbf{ $\mathcal{I}(t)$ }\\ \hline
    \{($p_{1}, 1$)\} \\
    \{($p_{2}, 0$)\} \\
    \{($p_{3}, 0$)\} \\
    \{($p_{4}, 0$)\} \\ 
    ...
    \{($p_{2}, 0$),($p_{4}, 0$)\} \\
    \{($p_{3}, 0$),($p_{4}, 0$)\} \\       
    \{($p_{1}, 1$),($p_{2}, 0$),($p_{3}, 0$)\} \\ 
    \{($p_{1}, 1$),($p_{2}, 0$),($p_{4}, 0$)\} \\ 
    \{($p_{1}, 1$),($p_{3}, 0$),($p_{4}, 0$)\} \\ 
...
As an example, let test set $T$ be \{ \{($p_{1}, 1$), ($p_{2}, 0$), ($p_{3}, 0$), ($p_{4}, 0$)\}, \{($p_{1}, 1$), ($p_{2}, 0$), ($p_{3}, 0$), ($p_{4}, 1$)\} \}. Table \ref{ex:specialschemasoftestset} shows the schemas of $\mathcal{S}(T)$.  Other hit schemas of $T$ that can appear in other test cases do not belong to $\mathcal{S}(T)$. For example, \{($p_{1}, 1$), ($p_{2}, 0$)\} can appear in the test case \{($p_{1}, 1$), ($p_{2}, 0$), ($p_{3}, 1$), ($p_{4}, 1$)\}, which is not in $T$. Hence, \{($p_{1}, 1$), ($p_{2}, 0$)\} is only one hit schema of $T$, but not the special schema of $T$.
...
\begin{table}[htbp]
 ...
 %   {\footnotesize
    ...
    \begin{tabular}{|c|} \hline
   \textbf{Test Case set} \\ \hline
   \{($p_{1}, 1$), ($p_{2}, 0$), ($p_{3}, 0$), ($p_{4}, 0$)\}\\
   \{($p_{1}, 1$), ($p_{2}, 0$), ($p_{3}, 0$), ($p_{4}, 1$)\}\\ \hline
   \textbf{ $\mathcal{S}(T)$ }\\ \hline
  \{($p_{1}, 1$), ($p_{2}, 0$), ($p_{3}, 0$)\}  \\
  \{($p_{1}, 1$), ($p_{2}, 0$), ($p_{3}, 0$), ($p_{4}, 0$)\} \\
  \{($p_{1}, 1$), ($p_{2}, 0$), ($p_{3}, 0$), ($p_{4}, 1$)\} \\ \hline
    \end{tabular}%
