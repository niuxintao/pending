...
A schema is called a \textbf{\emph{pending} schema}, if and only if it cannot be determined neither to be healthy schema nor faulty schema according to given information.
\end{definition}
